...
class Indicator4: BaseIndicator {
    ...
    override func startAnimate() {
        ...
        animate(view: dot1, delay: 0)
        animate(view: dot2, delay: 0.1)
        animate(view: dot3, delay: 0.2)
    }
    ...
    private func animate(view: UIView, delay: Double) {
        ...
        yPosAnimation.fromValue = view.frame.origin.y + (dotSize / 2)
        yPosAnimation.toValue = view.frame.origin.y - (dotSize / 2)
